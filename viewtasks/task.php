        ...
        <div class='row'>
            <div class='left'>
                ...
                <div class='upper'>
                    <div class='line'></div>
                    <div class='lefttext'>
                        <p class='title'>Fix robot</p>
                        <p class='description'>Fix the robot in the robotics centre please!</p>
                        <p class='assignedby'>Assigned by:Root</p>
                    </div>
                ...
                <div class='timings'>
                    <div class='start'>
                        <p>Start Time</p>
                        <p>3 January 2021, 0900</p>

                    </div>

                    <i id='arrow' class="fas fa-chevron-circle-right"></i>
