...
<div class='hero'>
    ...
    <div class="container">
            ...
            <div class="modal fade" id="feedback">
                <div class="modal-dialog modal-dialog-centered">
                    <div style="background-color:#8D1D25; font-family:Montserrat;"class="modal-content rounded-10">
                        ...
                        <h5 style="color:white; font-weight:bold;" class="modal-title w-100 text-center">Feedback Form</h5>
                        </div>
                        <div class="modal-body w-100 text-center">
                            ...
                            <br>
                            <button style="color:#8D1D25; background-color:white; width:100%;" class="btn" type="submit">Submit Feedback</button>
                            </form> 
                        </div>
                    </div>
                </div>
        ...
        <div class="thing">
          <h1 class="useraccount"><spann>User Account</spann><br><br><span>How do I sign up?<span><br><spanone>You can signup for an account by using this link <linkk onclick="location.href = 'https://www.swapamc.com/swapproj/signup'">https://www.swapamc.com/swapproj/faq/signup</linkk><br></spanone><br><hr><br><spannn>How do I login?<spannn><br><spanone>You can login to your account by using this link <linkk onclick="location.href = 'https://www.swapamc.com/swapproj/login'">https://www.swapamc.com/swapproj/faq/login</linkk></spanone></h1>
         </div>
    </div>
