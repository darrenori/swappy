...
if (isset($_GET)) {
    ...
    if ($role == 6 || $role == 5 || $role == 3) {
        ...
        echo "<div class='item'>";
        echo "<div class='static'>Add Task</div>";
    
    
        echo "<form class='form5' id='myform' action='/swapproj/employeemanager/taskmanager/addtaskinc' method=POST>";
        
        echo "<div class='pairing'>";
            echo "<div class='pairing1'><p>Task Name:</p></div>";
            echo "<div class='pairing2'><input type='text' name='taskname'></div>";
        echo "</div>";
    
    
        echo "<div class='pairing'>";
            echo "<div class='pairing1'><p>Task Details:</p></div>";
            echo "<div class='pairing2'><input type='text' name='taskdetails'></div>";
        echo "</div>";
        ...
        echo "<div class='pairing'>";
        echo "<div class='pairing1'><p>Date to Be Finished:</p></div>";
        echo "<div class='pairing2'><input type='datetime-local'  id='date' name='date'></div>";
        echo "</div>";
        ...
        echo "<div class='pairing2'>" .$jwtarrayinformation['username'] . "</div><br>";
        echo "</div>";
