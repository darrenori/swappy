...
<div class='sidebar'>
    ...
    if ($role == 6 || $role == 5 || $role == 3) {
        ...
        while ($query->fetch()) {
            ...
            echo "<td>" . "<a href='https://www.swapamc.com/swapproj/employeemanager/taskmanager/deletetask?task=$taskid&csrf=$csrf'><input style='border:none; color:red; text-align:left' type=button name=edit value=DELETE></a>" . "</td>";
            if (isset($edited)) {
                echo "<td>" . $edited . "</td";
            } else {
