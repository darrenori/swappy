...
<?php
    ...
    $query = $conn->prepare("SELECT user_username,task_id,task_name,task_details,task_progress,task_assignedby,task_dateassigned,task_datetofinish,task_dateedited
        ...
        echo "<div class='static'>All Tasks</div>";
        echo "<button class='add_task'><a href='https://www.swapamc.com/swapproj/employeemanager/taskmanager/addtask'>Add Task</a></div>";
        // echo "<div class='static'>Username of Employee : " . $employeeusername . "</div>";

        echo "<table class='table55'>";
        echo "<thead style='background-color:white'>";
        echo "<tr class='table_body55'>";
        echo "<th class='table_header55'>" . "Task" . "</th>";
        echo "<th class='table_header55'>" . "Details" . "</th>";
        echo "<th class='table_header55'>" . "Progress" . "</th>";
        echo "<th class='table_header55'>" . "Assigned by" . "</th>";
        echo "<th class='table_header55'>" . "Date assigned" . "</th>";
        echo "<th class='table_header55'>" . "To finish by" . "</th>";
        echo "<th class='table_header55'>" . "Edit" . "</th>";
        echo "<th class='table_header55'>" . "Delete" . "</th>";
        echo "<th class='table_header55'>" . "Edited on" . "</th>";

        echo "</tr>";
        echo "</thead>";
        echo "<tr class='blank_row'>
        <td bgcolor='#EEEEEE' colspan='9'>&nbsp;</td>
        </tr>";
        ...
        while ($query->fetch()) {
            ...
            echo "<td>" . "<a href='https://www.swapamc.com/swapproj/employeemanager/taskmanager/edittask?task=$taskid'><input style='border:none; color:red; text-align:left' type=button name=edit value=EDIT></a>" . "</td>";
            echo "<td>" . "<a href='https://www.swapamc.com/swapproj/employeemanager/taskmanager/deletetask?task=$taskid'><input style='border:none; color:red; text-align:left' type=button name=edit value=DELETE></a>" . "</td>";
            if (isset($edited)) {
                echo "<td>" . $edited . "</td";
            } else {
    ...
    // echo "<br><a href='https://www.swapamc.com/swapproj/employeemanager'>Back to Employee Management</a></div></div>";
