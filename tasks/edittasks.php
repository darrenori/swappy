...
if($query->execute()){
    ...
    if($query->fetch()){
        ...
        echo "<div class='item'>";
        echo "<div class='static'>Edit Task</div>";
        echo "<form class='form5' id='myform' method=POST action='https://www.swapamc.com/swapproj/employeemanager/taskmanager/edittaskinc'>";
        
            echo "<div class='pairing'>";
                echo "<div class='pairing1'><p>Task name:</p></div>";
                echo "<div class='pairing2'><input type=text name='name' value='".$name."'></div>";
            echo "</div>";

            echo "<div class='pairing'>";
                echo "<div class='pairing1'><p>Details:</p></div>";
                echo "<div class='pairing2'><input type=text name='details' multiple='multiple' value='".$details."'></div>";
            echo "</div>";

            echo "<div class='pairing'>";
            echo "<div class='pairing1'><p>Progress:</p></div>";

            echo "<div class='pairing2'>";
                if($progress==0){
                    echo '<select style="color: black" name="progress">';
            ...
            echo "<div class='pairing'>";
                echo "<div class='pairing1'><p>Assigned By:</p></div>";
                 echo "<div class='pairing2'><input type=text name='assignedby' value=$assignedby></div>";
            echo "</div>";
        // echo "<input type=submit value=submit>";

        echo "<input type='hidden' name='csrf' value='$csrf'>";
        echo "</form></div>
        <button class='submit-form' form='myform' type='submit'>Submit</button>
        </div></div>";
