...
echo "<div class='container5'>";
    echo   "<div class='role'>Employee Manager</div>
            <div class='item66'>
            <div class='static'>View Quantity</div>";
if($types!=null&&$alltypesvariant!=null){
    echo "<p class='static2' style='margin-left:30px'>$productname</p>";

    echo "<table style='margin-left:30px; margin-bottom:10px' border='1'>";
    echo "<tr>";
    ...
    //no types
    echo "<p class='static2'>$productname</p>";
...
echo "<a style='margin-left:30px; margin-top:20px' href='https://www.swapamc.com/swapproj/productmanager'>Back</a>";
