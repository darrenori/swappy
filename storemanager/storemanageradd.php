...
<div class='container5'>
    ...
    <div class='role'>Product Admin</div>
    <div class='item'>
        <div class='static'>Add New Store</div>
    <form  id='myform' class='form5'; method=POST enctype='multipart/form-data' action='https://www.swapamc.com/swapproj/storemanageraddinc'>
