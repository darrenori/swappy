...
<div class='nav-bar'>
    ...
    <div class='rowone'>
        ...
        <div class='banner-title'>
            <h2>01</h2>
            <h3>TPAMC</h3>
            <h1 id='plswork'>Nothing much.<br>Just the best <span>website</span><br>for the best <span>AMC</span></h1>
            <div class='buttoncontainer'>
                <?php
                echo "<button type='button' class='btntwo' onclick=" . '"window.location.href=' . "'https://www.swapamc.com/swapproj/allproducts';" . '">EXPLORE</button>';

                if (!isset($jwtarrayinformation)) {
                    echo "<button type='button' class='btnthree' onclick=" . '"window.location.href=' . "'https://www.swapamc.com/swapproj/login';" . '">LOGIN</button>';
                }
                ?>
            </div>
...
<script>
    ...
    let text = document.querySelectorAll('.banner-title h1');
    text.forEach(link => {
