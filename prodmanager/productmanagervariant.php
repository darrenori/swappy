...
echo "<form class='form5' id='myform' action='https://www.swapamc.com/swapproj/productmanageraddvariants' method='post'>";
...
for($i=0;$i<sizeof($alltypes);$i++){
    ...
    echo "<div class='pairing1'><p style='font-size: 30px' id='$alltypes[$i]' class='types'>Type: $alltypes[$i]</p></div>";


    echo "<div class='pairing2' id='inputfields$alltypes[$i]'>";   
    echo "<p>Variant:</p>";
