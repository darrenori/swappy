...
echo "<div class='item'>";
echo "<div class='static'>$productname</div>";


// echo "<p>$productname</p>";
// echo "<br><br><br>";

echo "<form class='form5' id='myform' action='https://www.swapamc.com/swapproj/productmanageraddtypes' method='post'>";
...
$(document).ready(function() {
    ...
    $(document).on("click", ".field", function(e){//on add input button click
        ...
        if(x < max_fields){ //max input box allowed
            ...
            $(wrapper).append('<div class="pairing2"><input type="text" class="field" name="type'+x+'"/><a href="#" class="remove_field">Remove</a></div>'); //add input box
        }
    });
