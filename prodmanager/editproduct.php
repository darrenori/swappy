...
if($query->fetch()){
    ...
    echo   "<div class='role'>Product Admin</div>
            <div class='item'>
            <div class='static'>Edit Product</div>";
    echo "<form id='myform' class='form5'; action='https://www.swapamc.com/swapproj/productmanager/editproductinc?id=$prodid' enctype='multipart/form-data' method='POST'>";


    echo "<div class='pairing55'>";
        echo "<div class='pairing1'></p>Name: $name</p></div>";
    echo "</div>";
        
    echo "<div class='pairing55'>";
        echo "<div class='pairing1'><p>About: </p></div>";
        echo "<div class='pairing222'><textarea style='margin-left:0px' rows='4' cols='50' name='about'>$about</textarea></div>";
    echo "</div>";
    ...
    echo "<div class='pairing55'>";
    if($picone!=null){
        echo "<div class='pairing1'><p>Pic one:</p></div>";
        $src = $image->show($picone);
        echo "<div class='pairing2'><img style='max-width: 100%; max-height: 100%;' src='$src';></div>";
        echo "<br>";
    ...
    echo "<div class='pairing55'>";
    if($pictwo!=null){
        echo "<div class='pairing1'><p>Pic two:</p></div>";
    ...
    echo "<div class='pairing55'>";
    if($picthree!=null){
        echo "<div class='pairing1'><p>Pic three:</p></div>";
    ...
    <a class='submit-form' href='https://www.swapamc.com/swapproj/productmanager/deleteproductinc?id=$prodid'>Delete</a>
    </div></div>";
