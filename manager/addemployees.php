...
echo "<form id='myform' style='padding-left: 20px' method=POST action=https://www.swapamc.com/swapproj/employeemanager/adduserinc>";
...
echo "</form>
</div><button class='submit-form' form='myform' type='submit'>Add</button>
