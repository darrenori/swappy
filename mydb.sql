...
-- Database: `db9471b`
--
DROP DATABASE IF EXISTS `db9471b`;
CREATE DATABASE IF NOT EXISTS `db9471b` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `db9471b`;

-- --------------------------------------------------------

--
-- Table structure for table `personb5eb7577`
--

DROP TABLE IF EXISTS `personb5eb7577`;
CREATE TABLE `personb5eb7577` (
  `ID52577` varchar(12) NOT NULL,
  `UNAMEE9577` varchar(36) NOT NULL,
  `CONTACTA5577` int(8) NOT NULL,
  `EMAILF7577` varchar(255) NOT NULL,
  `DOBFD577` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `personb5eb7577`
--

INSERT INTO `personb5eb7577` (`ID52577`, `UNAMEE9577`, `CONTACTA5577`, `EMAILF7577`, `DOBFD577`) VALUES
('13', 'alex lee', 83819291, 'jnsdjn@B4FB7F30E.YZ', '2021-05-13'),
('231', 'pleasework', 83182812, 'sdkmsm@B4FB7F30E.YZ', '23-05-2002');
...
--
-- Indexes for table `personb5eb7577`
--
ALTER TABLE `personb5eb7577`
  ADD PRIMARY KEY (`ID52577`);
--
-- Database: `mock`
--
DROP DATABASE IF EXISTS `mock`;
CREATE DATABASE IF NOT EXISTS `mock` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `mock`;
--
-- Database: `mydb`
--
...
('root', '[{\"db\":\"db9471b\",\"table\":\"personb5eb7577\"},{\"db\":\"db13ebe\",\"table\":\"item38e7a219\"}]');
...
('root', '2022-01-13 13:36:43', '{\"Console\\/Mode\":\"collapse\"}');
