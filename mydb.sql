...
--
-- Host: 127.0.0.1:3307
-- Generation Time: Dec 11, 2021 at 06:49 PM
...
--
ALTER TABLE `cart_typevariants`
  MODIFY `cart_typevariants_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `inventory`
  MODIFY `idquantityleft` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
